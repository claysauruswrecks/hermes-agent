    ...
    def test_suppression_propagates_across_run_coroutine_threadsafe(self, monkeypatch):
        ...
        try:
            ...
            async def _probe_on_loop_thread():
                ...
                return (
                    threading.current_thread() is not discovery_thread,
                    _is_interactive(),
                )
            ...
            def _discovery():
                ...
                with mod.suppress_interactive_oauth():
                    ...
                    result["cross_thread"], result["interactive"] = fut.result(
                        timeout=5
                    )
...
class TestWaitForCallbackPasteIntegration:
    ...
    def test_paste_prompt_NOT_shown_when_interactivity_suppressed(
