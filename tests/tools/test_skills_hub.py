...
class TestHermesIndexSearch:
    ...
    def test_search_ranks_exact_name_first(self):
        skills = [
            {
                "name": "z-cuda-helper",
                "description": "uses cuda",
                "source": "clawhub",
                "identifier": "clawhub/z-cuda-helper",
                "tags": [],
            },
            {
                "name": "cuda",
                "description": "the cuda skill",
                "source": "github",
                "identifier": "NVIDIA/skills/skills/cuda",
                "tags": [],
                "extra": {"provider": "NVIDIA"},
            },
        ]
    ...
    def test_search_does_not_break_at_limit_arbitrarily(self):
        ...
        skills = [
            {
                "name": f"thing-{i}",
                "description": "mentions cuda",
                "source": "clawhub",
                "identifier": f"clawhub/thing-{i}",
                "tags": [],
            }
            for i in range(30)
        ]
