...
def test_prefetch_reads_empty_abstract_content_within_budget(monkeypatch):
    ...
    assert "content for viking://user/peers/hermes/memories/one.md" in context
...
def test_prefetch_caps_full_content_reads(monkeypatch):
    ...
    assert (
        "full content for viking://user/peers/hermes/memories/events/mem_0.md"
        in context
    )
    assert (
        "full content for viking://user/peers/hermes/memories/events/mem_1.md"
        in context
    )
