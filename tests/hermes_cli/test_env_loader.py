...
def test_project_env_overrides_stale_shell_values_when_user_env_missing(
...
def test_project_env_is_sanitized_before_loading(tmp_path, monkeypatch):
    ...
    project_env = tmp_path / ".env"
    project_env.write_text(
        "TELEGRAM_BOT_TOKEN=0123456789:testANTHROPIC_API_KEY=sk-ant-test123\n",
        encoding="utf-8",
    )
