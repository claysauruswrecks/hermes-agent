...
class TestApiPost:
    def test_raises_on_network_error(self):
        ...
        with patch(
            "hermes_cli.dingtalk_auth.requests.post",
...
class TestBeginRegistration:
    ...
    def test_missing_nonce_raises(self):
        ...
        with patch(
            "hermes_cli.dingtalk_auth._api_post",
...
class TestWaitForSuccess:
    def test_returns_credentials_on_success(self):
        ...
        with (
            patch("hermes_cli.dingtalk_auth.poll_registration", side_effect=responses),
    ...
    def test_success_without_credentials_raises(self):
        ...
        with (
            patch(
                "hermes_cli.dingtalk_auth.poll_registration",
                return_value={
                    "status": "SUCCESS",
                    "client_id": "",
                    "client_secret": "",
