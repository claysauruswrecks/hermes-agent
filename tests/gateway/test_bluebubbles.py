...
class TestBlueBubblesHelpers:
    ...
    def test_clean_mention_text_strips_leading_wake_word(self, monkeypatch):
        ...
        assert (
            adapter._clean_mention_text("Hermes agent: summarize this")
            == "summarize this"
        )
        assert (
            adapter._clean_mention_text("please ask Hermes about this")
            == "please ask Hermes about this"
        )
