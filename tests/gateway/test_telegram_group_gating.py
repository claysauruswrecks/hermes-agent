...
def test_raw_bot_mention_fallback_does_not_match_email_or_substring():
    ...
    assert (
        adapter._should_process_message(_group_message("email ops@hermes_bot.example"))
        is False
    )
    assert (
        adapter._should_process_message(_group_message("prefix@hermes_bot hi")) is False
    )
